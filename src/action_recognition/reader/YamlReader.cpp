...
#include "procedural/action_recognition/reader/types/Yaml-Converter/ParsedSimpleAction_YAMLConverter.h"
...
//    std::cout << "Simple actions: " << simple_actions_.size() << std::endl;
