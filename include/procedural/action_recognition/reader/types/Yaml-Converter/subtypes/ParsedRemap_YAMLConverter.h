...
template<>
struct convert<action_recognition::ParsedRemaps_t>
{
    static Node encode(const action_recognition::ParsedRemaps_t& rhs)
    {
        Node node;
        return node;
    }
    static bool decode(const Node& node, action_recognition::ParsedRemaps_t& parsed_remaps)
    {
