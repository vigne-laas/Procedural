// Generated from /home/avigne/Projets/Procedural/catkin_ws/src/Procedural/include/procedural/old/reader/grammar/HATPLexer.g4 by ANTLR 4.13.1
...
public class HATPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"HTN", "ACTION", "PRECONDITIONS", "EFFECTS", "METHOD", "GOAL", "SUBTASK", 
			"TIMEPART", "FACTDATABASE", "FORALL", "COST", "DURATION", "SELECT", "WS", 
			"ADD_IN_SET", "REMOVE_FROM_SET", "EQUAL", "TEST_EQUAL", "TEST_DIFF", 
			"TEST_SET_IN", "TEST_SET_NOT_IN", "SUP", "SUP_EQUAL", "INF", "INF_EQUAL", 
			"SUP_TILD", "PLUS", "MINUS", "TIMES", "SLASH", "SEMICOLON", "POINT", 
			"STRING", "COLON", "QUESTIONMARK", "COMMENT", "LINE_COMMENT", "OpenPar", 
			"ClosePar", "OpenClosePar", "OpenCurly", "CloseCurly", "Comma", "IDENTIFIER", 
			"TYPE", "VARNAME", "ATTRIBUT", "NUMBER"
		};
	}
	...
	public HATPLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "HATPLexer.g4"; }
